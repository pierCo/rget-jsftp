...
var rgetJsFTP = module.exports = function (params, logger) {
    ...
    helper.mapObjectProperties(params, rgetParams);

    function createDownloadDescription(source, destination) {
        var root = fileFtpDescription.create();
        ...
        FtpConnectionPool.shortFtpPool.acquire(function (err, ftp) {
            ...
            ftp.ls(parentCompletePath, function (err, files) {
                ...
                files.forEach(function (file) {
                    var childDesc = fileFtpDescription.create();
